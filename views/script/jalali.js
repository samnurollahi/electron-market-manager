!(function () {
  ...
  !(function () {
    ...
    var e = function (t) {
      ...
      $ = function (t, n) {
        t &&
          (t.dispatchEvent(Z(n)),
          n === Y &&
            (t.dispatchEvent(Z("change")), t.dispatchEvent(Z("input"))));
      },
      ...
      at = function (t, n) {
        return [0, 31, 31, 31, 31, 31, 31, 30, 30, 30, 30, 30, it(t) ? 30 : 29][
          n
        ];
      };
    var rt,
          ...
          (function (t) {
            for (var n = tt(C, t.dpContainer), e = 0; e < 7; e++)
              tt(
                ...
                null,
                null,
                et(t.options.days[e], t.options.persianDigits)
              );
            for (
              var o = function (n) {
                  return (
                ...
                D = function (e) {
                  ...
                  var h = tt(
                    ...
                    null,
                    null,
                    et(a.day, t.options.persianDigits)
                  );
                  (h.day = a.day),
                    (h.month = a.month),
                    (h.year = a.year),
      ...
      yt = function (t) {
        ...
        t.options.date ||
          ...
          (null !== (n = t.input) &&
            void 0 !== n &&
            n.value &&
            !t.options.showSelectTimeBtnAlways) ||
          tt(
            N,
            e,
            z,
    ...
    var vt = /iphone|ipod|android|ie|blackberry|fennec/.test(
        null === (rt = window.navigator) ||
          void 0 === rt ||
          null === (st = rt.userAgent) ||
          void 0 === st
          ? void 0
          : st.toLowerCase()
      ),
      ...
      wt = function (t) {
        return (
          !e(gt.options._date) && e(t.date) && (t.date = gt.options._date),
          ...
          (t.initDate === q || t._initDateIsAttr) &&
            (delete t.initDate,
            (t._initDateIsAttr = !0),
